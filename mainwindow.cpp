...
static QWidget* createRegisterWidget(QStackedWidget* authStack, QStackedWidget* rootStack) {
    ...
    : QMainWindow(parent), stackedWidget(new QStackedWidget(this))
{
    ...
    QWidget *registerPage = createRegisterWidget(authStack, stackedWidget);
