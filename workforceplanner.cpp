...
// --- API CONFIGURATION ---
const QString GEMINI_API_KEY = "AIzaSyAYIp1l9QvK7DqsH7W4nMfaDPLQfNhpzg4";
...
void WorkforcePlanner::generateAiRecommendation() {
    ...
    QString endpoint = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + GEMINI_API_KEY;
    QUrl url(endpoint);
