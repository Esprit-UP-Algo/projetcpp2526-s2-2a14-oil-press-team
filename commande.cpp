...
Commande::Commande(int id, QString ref, QDate dateC, QString etat, QString nomC, QString adresseC, QDate dateL)
{
    this->id_commande = id;
    this->reference = ref;
...
bool Commande::ajouter()
{
    ...
    // Step 2: Insert
    QSqlQuery query;
    query.prepare("INSERT INTO COMMANDE (ID_COMMANDE, REFERENCE, DATE_COMMANDE, ETAT_COMMANDE, NOM_CLIENT, ADRESSE_CLIENT, DATE_LIVRAISON) "
                  "VALUES (:id, :ref, :dateC, :etat, :nom, :adr, :dateL)");
...
QSqlQueryModel* Commande::afficher()
{
    ...
    model->setQuery("SELECT ID_COMMANDE, REFERENCE, DATE_COMMANDE, ETAT_COMMANDE, NOM_CLIENT, ADRESSE_CLIENT, DATE_LIVRAISON FROM COMMANDE");
    ...
    model->setHeaderData(5, Qt::Horizontal, QObject::tr("Delivery"));
    return model;
}
...
{
    QSqlQuery query;
    query.prepare("UPDATE COMMANDE SET REFERENCE = :ref, DATE_COMMANDE = :dateC, ETAT_COMMANDE = :etat, NOM_CLIENT = :nom, ADRESSE_CLIENT = :adr, DATE_LIVRAISON = :dateL "
